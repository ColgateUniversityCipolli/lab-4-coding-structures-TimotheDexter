...
#if this works I will call my mother and tell her I love her... it didnt but i called anyway
```
...
#its a wonderful life when I finally got this to work
```
...
#| echo: false
#| results: 'asis'
cat("##", recipe1$title, "\n\n") #code in the recipe sections are copy and pasted versions of each other like I looked up how these worked and adapted them for them all
